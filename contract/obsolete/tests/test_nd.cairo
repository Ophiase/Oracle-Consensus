...
fn fill_oracle_predictions(dispatcher : IOracleConsensusNDDispatcher, predictions : @Array<WsadVector>) {
    let mut i = 0;
...
fn test_constrained_basic_execution() {
    ...
    if VERBOSE {
        ...
        println!("get_consensus_value : {}", wsadvector_to_string(dispatcher.get_consensus_value()));
