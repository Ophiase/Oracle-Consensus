...
use oracle_consensus::utils::{
    ...
    show_nd_felt_oracle_array, felt_wsad_to_string,
    wsadvector_to_string,
};
...
fn test_constrained_basic_execution() {
    ...
    if VERBOSE {
        ...
        println!("get_consensus_value : {}", wsadvector_to_string(dispatcher.get_consensus_value().as_wsad()));
        println!("get_first_pass_consensus_reliability : {}", felt_wsad_to_string(dispatcher.get_first_pass_consensus_reliability(), 3));
        println!("get_second_pass_consensus_reliability : {}", felt_wsad_to_string(dispatcher.get_second_pass_consensus_reliability(), 3));
        println!("----------------------");
    }
